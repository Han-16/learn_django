...
from .views import base_views, answer_views, question_views, comment_question_views, comment_answer_views
...
urlpatterns = [
    ...
    path('comment/vote/question/<int:comment_id>', comment_question_views.comment_vote_question, name = "comment_vote_question"),
